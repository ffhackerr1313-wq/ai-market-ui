  ...
  return (
    <div className="relative h-full w-full">
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-5">
        {item.tag && (
          <div
            className="mb-2 w-fit rounded px-2 py-0.5 text-xs font-semibold uppercase tracking-widest"
            style={{ background: "rgba(0,223,251,0.18)", color: "#00DFFB", border: "1px solid rgba(0,223,251,0.35)" }}
          >
            {item.tag}
          </div>
        )}
